...
app.get("/api/helpers", function (req, res) {
    res.json(data_json_1.default.helpers);
});
// Les services locaux
app.get("/api/services", function (req, res) {
    res.json(data_json_1.default.services);
});
// details du helper par id
function oneHelper(id) {
    return data_json_1.default.helpers.find(function (p) { return p.id === +id; });
}
app.get("/api/helpers/:id", function (req, res) {
    res.json(oneHelper(req.params.id));
});
// details du service par id
function oneService(id) {
    return data_json_1.default.services.find(function (p) { return p.id === +id; });
}
